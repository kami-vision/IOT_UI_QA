...
public class WebKamiCloudYearlyPlansPurchase {
    UIHelper app;
    ...
    @Link("https://kami-vision.atlassian.net/browse/WKC-59")
    @Test(description = "Purchase Yearly kami cloud plans- WKC-59", groups = {"Single_Smoke","web_KamiCloud", "en_locale"})
    public void webKamiCloudYearlyPlansPurchase() throws Exception {
        ...
        log.info("web kami cloud Yearly plan Purchase!");
        cloudScreenWeb.verifyYearlPlanPurchase();
        log.info("web kami cloud Yearly plan Purchase is successful!");
    }
}